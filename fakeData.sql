...
(2, 102, 3981, 4, 5, 'GC-202A'),
(2, 102, 3981, 4, 5, 'GC-202B'),
(2, 102, 3981, 4, 5, 'GC-202C'),
(2, 102, 3981, 4, 5, 'GC-202D'),
(3, 103, 3981, 4, 5, 'GC-303A'),
(3, 103, 3981, 4, 5, 'GC-303B'),
(3, 103, 3981, 4, 5, 'GC-303C'),
(3, 103, 3981, 4, 5, 'GC-303D'),
(1, 101, 3981, 4, 6, 'NH-101A'),
(1, 101, 3981, 4, 6, 'NH-101B'),
(1, 101, 3981, 4, 6, 'NH-101C'),
(1, 101, 3981, 4, 6, 'NH-101D'),
(2, 102, 3981, 4, 6, 'NH-202A'),
(2, 102, 3981, 4, 6, 'NH-202B'),
(2, 102, 3981, 4, 6, 'NH-202C'),
(2, 102, 3981, 4, 6, 'NH-202D'),
(3, 103, 3981, 4, 6, 'NH-303A'),
(3, 103, 3981, 4, 6, 'NH-303B'),
(3, 103, 3981, 4, 6, 'NH-303C'),
(3, 103, 3981, 4, 6, 'NH-303D'),
(1, 101, 3981, 4, 7, 'SH-101A'),
(1, 101, 3981, 4, 7, 'SH-101B'),
(1, 101, 3981, 4, 7, 'SH-101C'),
(1, 101, 3981, 4, 7, 'SH-101D'),
(2, 102, 3981, 4, 7, 'SH-202A'),
(2, 102, 3981, 4, 7, 'SH-202B'),
(2, 102, 3981, 4, 7, 'SH-202C'),
(2, 102, 3981, 4, 7, 'SH-202D'),
(3, 103, 3981, 4, 7, 'SH-303A'),
(3, 103, 3981, 4, 7, 'SH-303B'),
(3, 103, 3981, 4, 7, 'SH-303C'),
(3, 103, 3981, 4, 7, 'SH-303D');
...
(2, 102, 4354, 4, 2, 1, 'TR-202B'),
(2, 102, 4354, 4, 2, 1, 'TR-202C'),
(2, 102, 4354, 4, 2, 1, 'TR-202D'),
(3, 103, 4354, 2, 1, 1, 'TR-303A'),
(3, 103, 4354, 2, 1, 1, 'TR-303B'),
(1, 101, 5305, 2, 1, 2, 'CH-101A'),
(1, 101, 5305, 2, 1, 2, 'CH-101B'),
(2, 102, 5201, 4, 2, 2, 'CH-202A'),
(2, 102, 5201, 4, 2, 2, 'CH-202B'),
(2, 102, 5201, 4, 2, 2, 'CH-202C'),
(2, 102, 5201, 4, 2, 2, 'CH-202D'),
(3, 103, 5201, 4, 2, 2, 'CH-303A'),
(3, 103, 5201, 4, 2, 2, 'CH-303B'),
(3, 103, 5201, 4, 2, 2, 'CH-303C'),
(3, 103, 5201, 4, 2, 2, 'CH-303D'),
(1, 101, 5201, 4, 2, 3, 'MH-101A'),
(1, 101, 5201, 4, 2, 3, 'MH-101B'),
(1, 101, 5201, 4, 2, 3, 'MH-101C'),
(1, 101, 5201, 4, 2, 3, 'MH-101D'),
(2, 102, 5305, 2, 1, 3, 'MH-202A'),
(2, 102, 5305, 2, 1, 3, 'MH-202B'),
(3, 103, 3981, 2, 1, 3, 'MH-303A'),
(3, 103, 3981, 2, 1, 3, 'MH-303B'),
(1, 101, 4853, 2, 1, 4, '10W-101A'),
(1, 101, 4853, 2, 1, 4, '10W-101B'),
(2, 102, 4853, 2, 1, 4, '10W-202A'),
(2, 102, 4853, 2, 1, 4, '10W-202B'),
(3, 103, 4853, 2, 1, 4, '10W-303A'),
(3, 103, 4853, 2, 1, 4, '10W-303B');
...
INSERT INTO PARKING (Car_model, Car_color, Plate_num, Student_id) VALUES 
('Lambo', 'Red', 'BC23242', '9023223'),
('Camry', 'Silver', 'FE26442', '1243526'),
('CRV', 'Green',  'BP32563', '6293221');
